...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbx61pvXIfTZJbkdX4NOdhKCa-Mu8UBQV4WEDh6Xu9APM3HLaX_6CtYlb7QjMgKXdGW2kQ/exec"; 
...
const getInitialMockSettings = (): AppSettings => {
  const defaultSettings: AppSettings = {
    ...
    alamat: "Jl. Ikan Mas No. 16 Sidomukti Kecamatan Kota Kisaran Barat Kabupaten Asahan Provinsi Sumatera Utara Kode Pos 21217",
    telepon: "+628116152289",
    email: "info@sdn014688sidomukti.sch.id",
    ...
    sambutanKepalaSekolah: "Selamat datang di website resmi SPMB UPTD SDN 014688 Sidomukti. Kami berkomitmen untuk memberikan pelayanan pendidikan terbaik bagi putra-putri Anda. Mari bergabung bersama kami untuk mencetak generasi penerus bangsa yang cerdas, berakhlak mulia, dan berprestasi.",
